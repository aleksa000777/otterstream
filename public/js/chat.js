...
console.log($img);
  ...
  function addChatMessage (data, options) {
    ...
    // $usernameDiv.append( $('<img class="username">').attr('src', data.img).css({'width': '40px'}) );
    $usernameDiv.append( $('<span class="username">').text(data.username).css('color', getUsernameColor(data.username)) );
  ...
  socket.on('login', function (data) {
    ...
    var message = "Welcome to OtterStream Chat – ";
    log(message, {
      prepend: true
    });
